...
## The challenge:
See [TrueLayer - Backend Engineer Payments Challenge.pdf]([a link](https://github.com/adamfriswell/TrueLayerBackendEngineerChallenge/blob/master/readme.md)) file
